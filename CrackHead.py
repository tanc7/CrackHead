...
os.system('cat /root/CrackHead/banner_CrackHead.txt')
...
def airodump():
    ...
    if opt_Choice == "1":
        os.system("gnome-terminal -e 'bash -c \"python /root/CrackHead/CrackHead_Recon.py; exec bash\"'")
        airodump()
    elif opt_Choice == "0":
        main()
    elif opt_Choice == "2":
        os.system("gnome-terminal -e 'bash -c \"python /root/CrackHead/CrackHead_Targeted.py; exec bash\"'")
        airodump()
...
def aireplay():
    os.system("gnome-terminal -e 'bash -c \"python /root/CrackHead/CrackHead_Replay.py; exec bash\"'")
    main()
    return

def aircrack():
    os.system("gnome-terminal -e 'bash -c \"python /root/CrackHead/CrackHead_Aircrack.py; exec bash\"'")
    main()
    return
